...
class TvInfoModel {
  ...
  factory TvInfoModel.fromRawJson(String str) =>
      TvInfoModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TvInfoModel.fromJson(Map<String, dynamic> json) => TvInfoModel(
    adult: json["adult"],
